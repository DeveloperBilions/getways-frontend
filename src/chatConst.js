...
export const masterAgentFinalAnswers = {
  ...
  "What details are included in the Recharge Records list?":
    "In the Recharge Records list, you can view the following details: Action, Accounts, Recharged, Remark, Status, Failed Reason, Parent, Recharge Date. You can also filter the records by different criteria such as Search By and Status, and export the data in PDF and Excel formats. If you need more information or have any specific questions about the Recharge Records, feel free to ask!",
  // Filter Recharges
  "How do I filter Recharge Records by Account, Status, or Mode?":
  ...
  "What information is shown in the Redeem Records list?":
    "In the Redeem Records list, you can view the following information for Agents and Players under you: Action, Accounts, Redeemed, Remark, Status, Service Fee, Parent, Redeem Date. You can also filter the list by Search By and Status, export data in PDF and Excel formats, and take actions based on the status of the redeem requests. If you need more details or have any specific questions about redeem records, feel free to ask!",
