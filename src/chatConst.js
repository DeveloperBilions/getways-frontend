...
export const superUserFinalOptions = {
  ...
  "recharge-actions": [
    ...
    "What happens if I reject a Pending Confirmation recharge?",
  ],
  "view-redeems": [
  ...
  "export-reports": [
    ...
    "What data is included in the exported Summary reports?",
  ],
  "overview-report": [
...
export const superUserFinalAnswers = {
  ...
  "What happens if I reject a Pending Confirmation recharge?": `If you reject a Pending Confirmation recharge, the status of the recharge will be updated accordingly. The system will mark the recharge as Rejected Pending Confirmation, and the user will be notified of the rejection.`,
  ...
  "What does the Total Wallet Balance represent?": `The Total Wallet Balance in the Summary section represents the cumulative balance across all user wallets in the system. It provides an overview of the total available funds held by all Players, Agents, and Master Agents within the platform.`,
  ...
  // export-reports
  "How do I generate month-wise PDF or Excel reports for Recharge and Redeem?": `To generate month-wise PDF or Excel reports for Recharge and Redeem, follow these steps: 1. Go to the Summary section of the Super-User platform. 2. Provide the Start Date and End Date for the report period. 3. Click on the **Apply Filter** button. 4. You will see the summary data for the specified date range. 5. To generate the reports, click on the **Export** button at the top right of the page. 6. When prompted, select the desired month for which you want to export the report. 7. Choose the type of report you want to generate: - PDF for Recharge - Excel for Recharge - PDF for Redeem - Excel for Redeem By following these steps, you can easily generate month-wise PDF or Excel reports for Recharge and Redeem transactions on the platform. Let me know if you need further assistance!`,
  "What data is included in the exported Summary reports?": `In the exported Summary reports, you can expect to find the following data related to Players, Agents, and Master Agents: - Total number of users - Total Agents - Total Recharges - Total Redeems - Pending Recharges - Failed Redeems - Total Cashout Redeems Successful - Total Cashout Redeems Pending - Total Fees Charged - Total Wallet Balance - Total Recharge (Filtered) - You can filter the total recharge using a dropdown menu within the box. The available filter options are Wallet, Others, and All. By default, the filter is set to All.`,
