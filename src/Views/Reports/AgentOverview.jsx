                              ...
                              data: [
                                {
                                  ...
                                  label: `Recharge: ${totalData.totalRecharge?.toLocaleString() || 0}`,
                                  color: "#43A047",
                                },
                                {
                                  id: 1,
                                  value: totalData.totalRedeem,
                                  label: `Redeem: ${totalData.totalRedeem?.toLocaleString() || 0}`,
                                  color: "#E53935",
                                },
                                {
                                  id: 2,
                                  value: totalData.totalCashout,
                                  label: `Cashout: ${totalData.totalCashout?.toLocaleString() || 0}`,
                                  color: "#FB8C00",
                                },
                              ],
                              valueFormatter: () => "",
