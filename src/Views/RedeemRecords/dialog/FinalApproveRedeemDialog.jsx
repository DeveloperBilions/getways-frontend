...
const FinalApproveRedeemDialog = ({ open, onClose, record, handleRefresh }) => {
  ...
  const giftCards = [
    {
      ...
      productImage:
        "https://app.giftango.com/GPCGraphics/C1951_1501_Mastercard_Reward_Pathward_Virtual_Sweep_Termination_Cover_Front_v3_083022_CR80_092222_300x190_RGB.png",
      productDescription:
        "The MastercardÂ? eReward Virtual Account is a convenient and flexible way to recognize employees and encourage customer loyalty.Â \n\n  Available in open denominations\n  Maximum card balances up to $10,000\n ",
      termsAndConditions:
        "<a href='https://app.giftango.com/GPCGraphics/C1951_600_eReward_Dual_Visa_MC_Virtual_Physical_Pathward_Sweep_No_Cash_Intl_CHA_v4_061422.pdf'>Cardholder agreement</a>\nVirtual Account is issued by PathwardÂ? , N.A., Member FDIC, pursuant to license by Mastercard International Incorporated. Virtual Account can be used online or via phone everywhere debit Mastercard is accepted. NO CASH OR ATM ACCESS. Terms and Conditions apply. See Virtual Accountholder Agreement for details.",
      howToUse: "",
      expiryAndValidity: "",
      valueRestrictions: {
        minVal: 5.0,
  ...
  const handleSubmit = async (event) => {
    ...
    setLoading(true);
    try {
      await dataProvider.finalApprove(
        record?.id,
        redeemRemarks,
        redeemAmount,
        selectedGiftCard?.productId || null
      );
